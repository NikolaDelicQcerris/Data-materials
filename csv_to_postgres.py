...
df = pd.read_csv("/home/qcerris/Desktop/Data-project/Data-materials/cars.csv", index_col=False)
...
connection,cursor=connect_to_db(host=host,database=database,user=user,password=password)
